...
// Номер акта: «149-ФЗ», «1-ФКЗ», «511», «28-р», «146/2».
// Хвостовые точки и дефисы исключены явно: без этого «149-ФЗ...» в конце
// предложения давал бы номер «149-ФЗ...» и ломал сопоставление актов.
