...
--
-- Официальные документы государственных органов не являются объектами
-- авторских прав (подпункт 1 пункта 6 статьи 1259 Гражданского кодекса
-- Российской Федерации), поэтому чтение корпуса открыто всем
